...
return (
        ...
        <body>
            ...
            <NavBar/>
            <div className="bg-white w-8/12 h-3/6 font-typewriter text-black text-2xl flex flex-wrap rounded-xl"> 
            ...
            <div className="w-8/12 p-4 flex justify-center ">
                <button className="w-2/6 bg-black text-white rounded-xl">Option 1</button>
                <div className="w-2/6"></div>
                <button className="w-2/6 bg-black text-white rounded-xl">Option 2</button>
            </div>
            </div>
        </body>
        </>
